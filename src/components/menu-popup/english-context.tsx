  ...
  return (
    <>
      <div>
        ...
        l&rsquo;ERG), l&rsquo;Association Nationale des Écoles supérieures d&rsquo;Art françaises
        (ANdÉA) et l&rsquo;atelier des artistes en exil (aa-e) avec le soutien du programme Erasmus+
        de l&rsquo;Union Européenne.
      </div>
      <div>
        Une réflexion transnationale sur les enjeux des résidences organisées dans les écoles
        d&rsquo;art a permis d&rsquo;identifier des points de vigilance, puis de créer un outil
        d&rsquo;accueil facilitateur conçu comme un jeu de cartes. L&rsquo;outil proposé synthétise
        des recommandations et des « bonnes pratiques », à ajuster selon la situation de
        l&rsquo;artiste, le contexte et les possibilités de chaque école. Tout part de la volonté
        d&rsquo;enrichissement mutuel des écoles et des artistes en exil.
      </div>
      <div>
      ...
      <div>
        ...
        metteur·euses en scène, scénographes, cinéastes … venu·es d&rsquo;Afghanistan, de Birmanie,
        de Hong-Kong, du Kurdistan, du Liban, de Palestine, de République du Congo, de République
        démocratique du Congo, de Russie, de Syrie, de Tunisie, d&rsquo;Ukraine….Le monde entier
