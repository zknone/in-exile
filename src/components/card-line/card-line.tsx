...
const CardLine = (props: {
  ...
  return (
    <>
      {mode === 'subCategory' && (
        <div
          className={cn('absolute z-20 flex justify-center gap-x-2', {
      ...
      {mode === 'category' && (
        <div
          className={cn(
            ...
            {
              'top-[14%]': state.lang !== 'noLang' && state.category !== 'noCategory'
            }
          )}
        >
          {chosenData?.map((item) =>
      ...
      {mode === 'language' && (
        <div
          className={cn(
            ...
            {
              'top-[26%]': state.lang !== 'noLang' && state.category !== 'noCategory'
            }
          )}
        >
